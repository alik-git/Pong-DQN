...
with warnings.catch_warnings():
    ...
    if __name__ == "__main__":
        ...
        net = dqnetwork.DQNetwork(env.observation_space.shape, env.action_space.n).to(device)
        tgt_net = dqnetwork.DQNetwork(env.observation_space.shape, env.action_space.n).to(device)
